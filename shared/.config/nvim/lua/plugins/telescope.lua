        ...
        follow = true,
			...
			pickers = {
				find_files = {
					...
					--but sometimes in a project I want to manual ignore a directory, not global
					--therefore added the ".searchignore"
					--then in the project create a file .searchignore and add there the path to exclude
					find_command = {
						"rg",
						"--files",
						"--hidden",
